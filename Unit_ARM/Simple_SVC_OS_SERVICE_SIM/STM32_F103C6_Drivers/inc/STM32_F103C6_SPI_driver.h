...
#define COMMUNICATION_MODE_2LINE_RXE_ONLY		(uint16_t) (1<<10)
...
void MCAL_SPI_Send_Data(SPI_Typedef_t *SPIx, uint16_t *pTxBuffer, enum Polling_Mechanism_SPI Polling_En);
void MCAL_SPI_Recieve_Data(SPI_Typedef_t *SPIx, uint16_t *pRxBuffer, enum Polling_Mechanism_SPI Polling_En);

void MCAL_SPI_TX_RX(SPI_Typedef_t *SPIx, uint16_t *pTxBuffer, enum Polling_Mechanism_SPI Polling_En);
